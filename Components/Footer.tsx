...
const Footer = () => {
  return (
    <div
      id="contact"
      className="pt-[8rem] pb-[4rem] bg-[#02050a] mx-aut justify-center"
    >
      <div className="grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 lg:grid-cols-3 md:grid-cols-2 w-[80%] mx-auto gap-[3rem] justify-center">

  ...
  return (
    <div className="flex flex-col text-center justify-center">
      ...
      <p className="text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto">
        ...
        minima eius mollitia impedit accusamus voluptatem, alias excepturi
        perferendis maxime, aliquid incidunt veritatis non, aspernatur quibusdam
        laboriosam! Consequuntur harum sit voluptates.
      </p>
    </div>
  );
};
